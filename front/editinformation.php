...
<div class="navbar">
    ...
    <a href="viewinformation.php" class="login-btn" style="background:#005bbb;color:white;padding:10px 22px;border-radius:8px;text-decoration:none;">
        Back
    </a>
</div>
...
<div class="container">
    ...
    <form action="../Backend/editAction.php" method="POST">
        ...
        <div class="form-group">
            <label>Age</label>
            <input type="number" name="age" value="<?php echo $patient['Age']; ?>" required disabled>
        </div>
